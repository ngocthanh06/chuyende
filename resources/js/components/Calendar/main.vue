        ...
        <div class="card-body">
          <div class="list-view">
              ...
              <div class="ttLeff">
                ...
                <div class="form-group flatpickr">
                  ...
                  >
                    ...
                    <option
                      v-for="items in getCompanies"
                      :key="items.idComp"
                      :value="items.idComp"
                    >{{items.nameComp}}</option>
                  </select>
                </div>
                <!-- <end công ty -->
              </div>
            ...
            <div class="content">
                ...
                <div class="titleTableSearch">
                  <div class="name-Search">
                    <i
                      ...
                      style="font-size: 13px; padding-left: 10px; padding-right: 5px;"
                    >
                      <svg
                        viewBox="64 64 896 896"
                        focusable="false"
                ...
                <div v-for="(item, index) in getEmpCom()" :key="index" class="L_item">
                  ...
                  <div v-for="val in ChangeCaLam()" :key="val" class="i_desc titleTable">
                    ...
                    <div v-for="(value, index) in ValueCaLam" :key="index" v-if="value != null">
                      ...
                      <div
                        class="hidebutton"
                        v-if="val === value.WS_date && item.User_id === value.User_id"
                      >
                        <button
                          href="#EditModal"
                          data-toggle="modal"
                          ...
                          role="button"
                          v-on:click="EditCaLam(item.User_id, val)"
                          class="btn btn-pill btn-outline-success"
                        >Đã đăng ký</button>
                      </div>
                    </div>
                    <button
                      v-on:click="setCaLam(item.User_id, val)"
                      data-toggle="modal"
                      data-target="#myModal"
                      type="button"
                      class="add_btn"
              ...
              <!-- Add CaLam -->
              <modelCalam
                v-bind:getCaLamProp="getCaLam"
                v-bind:calam="idCaLam"
