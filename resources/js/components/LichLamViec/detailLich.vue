              ...
              <div class="overlay-action">
                ...
                <el-dropdown @command="delCaLam" style="width: 33%">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item v-if="val.status != 0" :command="{text: 'del', value: val, idCa: detailCa.idCa , date: detailCa.date }" icon="el-icon-delete" style="color: red">Xóa</el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </div>
            </div>
